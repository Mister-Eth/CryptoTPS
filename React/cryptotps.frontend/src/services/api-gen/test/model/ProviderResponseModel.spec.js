...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoTPSApi.ProviderResponseModel();
  });
  ...
  describe('ProviderResponseModel', function() {
    it('should create an instance of ProviderResponseModel', function() {
      ...
      //var instance = new CryptoTPSApi.ProviderResponseModel();
      //expect(instance).to.be.a(CryptoTPSApi.ProviderResponseModel);
    });
