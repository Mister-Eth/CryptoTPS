...
* <pre>
* var CryptoTpsApi = require('index'); // See note below*.
* var xxxSvc = new CryptoTpsApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new CryptoTpsApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new CryptoTpsApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new CryptoTpsApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
