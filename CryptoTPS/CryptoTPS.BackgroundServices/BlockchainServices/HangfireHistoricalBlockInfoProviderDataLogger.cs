...
namespace CryptoTPS.Services.BlockchainServices
{
    ...
    {
        public HangfireHistoricalBlockInfoProviderDataLogger(T instance, ILogger<HangfireBackgroundService> logger, CryptoTPSContext context) : base(instance, logger, context)
        {
        }
