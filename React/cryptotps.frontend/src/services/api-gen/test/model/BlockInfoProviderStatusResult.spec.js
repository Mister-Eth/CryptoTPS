...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoTPSApi.BlockInfoProviderStatusResult();
  });
  ...
  describe('BlockInfoProviderStatusResult', function() {
    it('should create an instance of BlockInfoProviderStatusResult', function() {
      ...
      //var instance = new CryptoTPSApi.BlockInfoProviderStatusResult();
      //expect(instance).to.be.a(CryptoTPSApi.BlockInfoProviderStatusResult);
    });
